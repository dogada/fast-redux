...
var nestedActionCreator = function nestedActionCreator(actionCreator, defaultNestedState) {
  return function (reducer, name) {
    if (typeof reducer !== 'function') throw new Error('Reducer must be a function.');
    return actionCreator(name || reducer.name, function () {
...
function nestedConfig(parentActionCreator, getParentState, defaultNestedState) {
  return {
